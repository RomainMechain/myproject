# Generated by Django 5.1.1 on 2024-09-12 06:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(blank=True, max_length=10, null=True, unique=True)),
                ('attributes', models.ManyToManyField(blank=True, related_name='product_item', to='LesProduits.productattributevalue')),
